extends "res://scripts/world/city_chunk_streamer_3d_v063.gd"
...
func _build_vehicle_sprite_0517(parent: Node3D, pos: Vector3, yaw: float, atlas_index: int, key: String) -> void:
	...
	vehicle.add_to_group("vehicle_streamed_066")
...
func get_vehicle_streaming_debug_066() -> Dictionary:
	return {
		"version": "0.6.6",
		"streamed_066": get_tree().get_nodes_in_group("vehicle_streamed_066").size(),
		"visual_066": get_tree().get_nodes_in_group("vehicle_art_066").size(),
		"old_ruin_runtime": 0
	}
