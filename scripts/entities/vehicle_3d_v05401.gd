...
const VEHICLE_ATLAS_PATH_05401 := "res://assets/visual_rework/fdc_vehicle_atlas_05401.svg"
...
func _build_vehicle_0530() -> void:
	...
	if sprite_0530 == null:
		return
	if ResourceLoader.exists(VEHICLE_ATLAS_PATH_05401):
		var atlas := load(VEHICLE_ATLAS_PATH_05401) as Texture2D
		if atlas != null:
			sprite_0530.texture = atlas
		...
		set_meta("vehicle_visual_version", "0.5.40-fallback")

func _refresh_sprite_orientation_0530() -> void:
	if sprite_0530 == null:
		return
	if not ResourceLoader.exists(VEHICLE_ATLAS_PATH_05401):
...
func get_visual_rework_debug_05401() -> Dictionary:
	return {
		"atlas": VEHICLE_ATLAS_PATH_05401,
		"atlas_available": ResourceLoader.exists(VEHICLE_ATLAS_PATH_05401),
